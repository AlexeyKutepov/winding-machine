...
boolean servoPulseActive = false;
unsigned long servoPulseStartUs = 0;
unsigned long servoLastRefreshUs = 0;
...
void updateServoSignal() {
  ...
  if (!servoPulseActive && nowUs - servoLastRefreshUs >= SERVO_REFRESH_INTERVAL_US) {
    servoLastRefreshUs = nowUs;
    servoPulseStartUs = nowUs;
